        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="get">
                    ...
                    <input type="month" name="bulan" id="bulan" value="{{request('bulan')}}" class="col-sm-3">
                    <button class="btn btn-outline-primary" type="submit">Report</button>
                    @if($bulanDanTahun)
                    <a class="btn btn-outline-primary" type="button" href="{{route('service.reportPdfMonth',$bulanDanTahun)}}">Download PDF
